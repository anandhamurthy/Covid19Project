...
public class PersonAdapter extends RecyclerView.Adapter<PersonAdapter.ImageViewHolder> implements Filterable {
    ...
    public PersonAdapter(Context context, List<Persons> mPrescriptionList, PersonAdapter.SearchAdapterListener listener) {
        mContext = context;
    ...
    @Override
    public PersonAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.single_layout_persons_details, parent, false);
        return new PersonAdapter.ImageViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final PersonAdapter.ImageViewHolder holder, final int position) {
